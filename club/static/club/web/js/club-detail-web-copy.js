...
finishedEventsWrap.addEventListener("click", (e) => {
    console.log("들어옴")
    if (e.target.matches(".club-detail-like-icon")) {

    }
})

// 하트 아이콘 클릭 시 모달창 하트 이미지 변경, 모달창 출력
const activeLikeBtns = finishedEventsWrap.querySelectorAll(".club-detail-like-button");
const emptyHearts = finishedEventsWrap.querySelectorAll(".club-detail-like-button .club-detail-like-icon.empty");
const fullHearts = finishedEventsWrap.querySelectorAll(".club-detail-like-button .club-detail-like-icon.full");
// 전체 모달
        ...
        if (ongoingActivities.length === 0) {
            ...
            for (let ongoingActivity of ongoingActivities) {
                ...
                text += `
                            ...
                            <div class="club-detail-like-wrap ${ongoingActivity.id}">
        ...
        if (finishedActivities.length === 0) {
            ...
            for (let finishedActivity of finishedActivities){
                ...
                text += `
                            ...
                            <div class="finished-events-like-wrap ${finishedActivity.id}">
                                <button class="finished-events-like-btn">
                                    <span>
                                        <svg data-v-e13ecf0e="" xmlns="http://www.w3.org/2000/svg" class="club-detail-like-icon empty${finishedActivity.id}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <svg data-v-e13ecf0e="" xmlns="http://www.w3.org/2000/svg" class="club-detail-like-icon full${finishedActivity.id}" viewBox="0 0 20 20" fill="currentColor">
