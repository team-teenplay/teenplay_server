    ...
    if (teenchin.length ===0){
        ...
        teenchin.forEach((teenchin)=>{
            ...
            <div class="teenchin-box">
                <div class="teenchin-items">
                    ...
                    <a href="">
                        ...
                        <div class="profile-info-contents">
                            <div class="profile-name">송서경</div>
                 ...
                 <div class="teenchin-box">
                    <div class="teenchin-items">
                        ...
                        <a href="">
                            ...
                            <div class="profile-info-contents">
                                <div class="profile-name">박지원</div>
                                <div class="profile-info-item">
                                    <div style="margin-right: 10px">
                                        <span>활동</span>
                                        <span>21</span>
                        ...
                        <div class="teenchin-btn-container">
                            <div class="teenchin-btn-box">
                                <button class="teenchin-agree-btn" type="button">
             ...
             if(teenchin.is_friend ===-1 || teenchin.sender_id === member_id){
                 text += `
                 <div class="teenchin-box">
                    <div class="teenchin-items">
                        <!-- 틴친 상세프로필 이동 주소 필요 -->
                        <a href="">
                            ...
                            <div class="profile-info-contents">
                                <div class="profile-name">김규산</div>
                                <div class="profile-info-item">
                                    <div style="margin-right: 10px">
                                        <span>활동</span>
                                        <span>21</span>
                        ...
                        <div class="teenchin-btn-container">
                            <div class="teenchin-btn-box">
                                <button class="teenchin-wait-btn" type="button">
...
teenchinService.getList(member_id, page, showList).then((text) => {
    teenchinshow.innerHTML += text;
});


teenchinService.getList(member_id, page, showList);
