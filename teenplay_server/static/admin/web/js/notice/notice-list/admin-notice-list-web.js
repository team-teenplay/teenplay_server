        ...
        pagination.notices.forEach((page) => {
            text += `
                <li class="main-user-list" data-id="${page.id}">
                    ...
                    <div id="title${page.id}" class="main-user-list-name">${page.notice_title}</div>
            ...
            text += `
                <div class="main-user-list-detail">
                    ...
                    <input type="hidden" id="content${page.id}" value="${page.notice_content}">
                </li>
            `
        })
        return text;
...
function allShowList() {
    adminNoticeService.getPagination(page, category, keyword, CreateService.showList).then((text) => {
...
function allShowPaging() {
    adminNoticeService.getPagination(page, category, keyword, CreateService.showPaging).then((text) => {
...
function CountShowText() {
    adminNoticeService.getPagination(page, category, keyword, CreateService.CountText).then((text) => {
